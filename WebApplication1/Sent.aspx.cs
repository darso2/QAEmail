...
namespace WebApplication1
{
    public partial class Sent : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            inboxtable.InnerHtml += "<tr> <th class=\"auto-style2\">From</th><th class=\"auto-style2\">To</th>  <th class=\"auto-style1\"> Subject</th> <th> Date (Month/Day/Year) </th></tr>";
            cmd.CommandText = "Select * from Emails where fromUser='" + useremail + "';";
            ...
            using (SqlDataReader r = cmd.ExecuteReader())
            {
                while (r.Read())
                {
                    ...
                    inboxtable.InnerHtml += "<tr> <td> " + from + "</td> <td>"+to+" </td><td> <a href=\"message.aspx?id=" + id + "&returnstring=sent\">" + subject + "</a></td> <td> " + date + " </td><tr>";
                }
            }
